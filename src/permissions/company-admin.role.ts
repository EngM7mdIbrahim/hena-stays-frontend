...
const propertyScopeCallback = (user: User | null, property?: Property | null) =>
  extractId(user?.company, '_id') === extractId(property?.company, '_id')
...
const projectScopeCallback = (user: User | null, project?: Project | null) =>
  extractId(user?.company, '_id') === extractId(project?.company, '_id')
...
export const companyAdminRolePermissions: RolePermissions = {
